  ...
  return (
    <section className="py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-20">
        ...
        >
          <h2 className="text-3xl md:text-5xl font-cyber mb-6 glitch" data-text="READY TO HACK THE FUTURE?">
            READY TO HACK THE <span className="neon-text-red">FUTURE</span>?
          </h2>
          <p className="text-xl mb-10 text-gray-300">
            Join hundreds of innovators at CyberHack 2023 and be part of a transformative tech experience.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link 
              to="/register" 
              className="font-cyber bg-cyber-red px-8 py-4 rounded clip-slant hover:shadow-neon-red transition-all duration-300 text-lg uppercase tracking-wider"
            >
              Register Now
            </Link>
            <a 
              href="#" 
              className="font-cyber border border-neon-blue px-8 py-4 rounded clip-slant hover:shadow-neon-blue transition-all duration-300 text-lg uppercase tracking-wider"
            >
              Download Brochure
            </a>
          </div>
      ...
      <div className="absolute left-0 top-1/4 w-32 h-32 opacity-20 animate-pulse-neon">
      ...
      <div className="absolute right-0 bottom-1/4 w-40 h-40 opacity-20 animate-pulse-neon">
        <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
