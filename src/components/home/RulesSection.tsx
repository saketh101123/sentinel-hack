...
const RulesSection = () => {
  const rules = [
    ...
    },
    {
      ...
      icon: <Check className="h-8 w-8 text-neon-blue" />,
      type: "requirement"
    },
    {
      id: 3,
    ...
    },
    {
      ...
      icon: <AlertTriangle className="h-8 w-8 text-cyber-red" />,
      type: "restriction"
    },
    {
      id: 5,
      ...
      <div className="container mx-auto px-4 z-10 relative">
        ...
        >
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-cyber font-bold mb-4">
            <span className="neon-text-blue">COMPETITION</span> <span className="neon-text-red">RULES</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          <motion.div 
            ...
            viewport={{ once: true }}
            className="bg-black/30 border border-neon-blue/30 p-6 rounded-lg glassmorphism"
          >
            <h3 className="text-2xl font-cyber font-bold mb-6 neon-text-blue">Requirements</h3>
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
            className="bg-black/30 border border-neon-red/30 p-6 rounded-lg glassmorphism"
          >
            <h3 className="text-2xl font-cyber font-bold mb-6 neon-text-red">Restrictions</h3>
            <div className="space-y-6">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="mt-12 p-6 rounded-lg bg-black/30 border border-white/10 glassmorphism"
        >
